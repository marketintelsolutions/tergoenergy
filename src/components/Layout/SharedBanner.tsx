...
const SharedBanner: React.FC<{ img?: string | null; text: string }> = ({
  ...
  return (
    <section
      ...
      className="w-[95%] md:w-[85%] mx-auto max-w-[1600px] flex items-end justify-center pb-12 md:pb-16 lg:pb-[100px] rounded-[25px] md:rounded-[50px] h-[300px] md:h-[400px] lg:h-[478px]"
    >
